...
class Login extends Component {
    ...
    ➡️Check image for more info</div>
                        ...
                        <div class="wrap-how-works">
                            ...
                            <div class="how-works">
                                ...
                                <div class="step">
                                    ...
                                    <div class="wrap-label">
                                        <h6 class="label">3. Eloboost24 proceed<br></br> the payment</h6>
                                    </div>
                                </div>
                                <div class="separator"></div>
                                <div class="step">
                        ...
                        <div class="wrap-big-note">
                            <div class="big-note">
                                ...
                                <div class="note attach-readmore active" >
                                    <p>
                                    ...
                                    <p>
                                        Eloboost24 Group LTD<br></br>
    Unit 4e Enterprise Court, Farfield Park<br></br>
    S63 5DB - Rotherham<br></br>
    United Kingdom<br></br>
                                    </p>
                                    <p>
                                        The e-mail of the service provider is: support@eloboost24.eu<br></br><br></br>
    ...
    - the account with the eloboost24 label (violet) or verified seller label (green) extend your warranty period to 14-days<br></br>
    ...
    *the minimum applied fee is 4 EUR/USD<br></br> <br></br>
    ...
    - you breach the General Terms and Conditions of Sale of the eloboost24.eu,<br></br>
