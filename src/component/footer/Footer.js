            ...
            <div class="container">
                <div class="row">
                    ...
                    <Fade bottom delay={200}>
                        <h5>Services</h5>
                        <ul>
                            <li><a  ><span class="icon-double-angle-right"></span> Live Chat</a></li>
                            <li><a  ><span class="icon-double-angle-right"></span> Years on Market</a></li>
                            <li><a  ><span class="icon-double-angle-right"></span> Payment Methods</a></li>
                            <li><a  ><span class="icon-double-angle-right"></span> 24/7 Active help sport</a></li>
                        </ul>
                        </Fade>
                    </div>
                    ...
                    <Fade bottom delay={300}>
                        <h5>Quick Link</h5>
                        <ul>
                            <li><a  ><span class="icon-double-angle-right"></span> Terms & Conditions</a></li>
                            <li><a  ><span class="icon-double-angle-right"></span> Contact</a></li>
                            <li><a  ><span class="icon-double-angle-right"></span> FAQ</a></li>
                            <li><a  ><span class="icon-double-angle-right"></span> Privacy Policy</a></li>
                        </ul>
                        </Fade>
                    </div>
